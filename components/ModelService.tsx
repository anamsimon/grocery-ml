...
export class ModelService {
  ...
  ): Promise<IModelPredictionResponse> {
    const predictionResponse = {
      timing: null,
      predictions: null,
      error: null,
    } as IModelPredictionResponse;
    try {
      ...
      tf.tidy(() => {
        ...
        const predictionsTensor: tf.Tensor = this.model.predict(
          preProcessedImage
        ) as tf.Tensor;
        ...
        // post processing
        predictionResponse.predictions = decodePredictions(
          predictionsTensor,
          this.model_classes,
          AppConfig.topK
        );
